            ...
            <div>
                ...
                <div className="Cards">
                    {this.state.article.map((element) => {
                        return <div className="card newsCard" key={element.url}>

                            <img src={element.urlToImage ? element.urlToImage : "https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/LJOCJXTPEUI6ZMPCAU45VD2EKE.jpg&w=1440"} className="card-img-top" alt="..." />
                ...
                <div className="btn-group arrowButtons" role="group" aria-label="Basic example">
                    <button type="button" disabled={this.state.page <= 1} className="btn btn-primary prevNextButton" onClick={this.handlePrevClick}>&#8592; Previous</button>
